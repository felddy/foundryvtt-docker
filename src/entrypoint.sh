...
find /data -path "${CHOWN_EXCLUDE_USER_MOUNT:-}" -prune -o -exec chown "${FOUNDRY_UID:-foundry}:${FOUNDRY_GID:-foundry}" {} +
...
export CONTAINER_PRESERVE_CONFIG FOUNDRY_ADMIN_KEY FOUNDRY_AWS_CONFIG \
  ...
  FOUNDRY_SSL_KEY FOUNDRY_TURN_CONFIGS FOUNDRY_UPNP FOUNDRY_WORLD
