...
|`felddy/foundryvtt:11.306.0`| An exact image version. |
|`felddy/foundryvtt:11.306`| The most recent image matching the major and minor version numbers. |
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `11.306` |
...
```console
docker build \
  --build-arg VERSION=11.306.0 \
  --tag felddy/foundryvtt:11.306.0 \
