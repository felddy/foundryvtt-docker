...
|`felddy/foundryvtt:9.236.0`| An exact image version. |
|`felddy/foundryvtt:9.236`| The most recent image matching the major and minor version numbers. |
...
distribution's name must be of the form: `foundryvtt-9.236.zip`
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `9.236` |
...
```console
docker build \
  --build-arg VERSION=9.236.0 \
  --tag felddy/foundryvtt:9.236.0 \
