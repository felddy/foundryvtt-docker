...
|`felddy/foundryvtt:10.265.0`| An exact image version. |
|`felddy/foundryvtt:10.265`| The most recent image matching the major and minor version numbers. |
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `10.265` |
...
```console
docker build \
  --build-arg VERSION=10.265.0 \
  --tag felddy/foundryvtt:10.265.0 \
