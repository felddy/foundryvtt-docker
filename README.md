...
|`felddy/foundryvtt:0.8.9`| An exact version. |
...
distribution's name must be of the form: `foundryvtt-0.8.9.zip`
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `0.8.9` |
...
```console
docker build \
  --build-arg VERSION=0.8.9 \
  --tag felddy/foundryvtt:0.8.9 \
