...
|`felddy/foundryvtt:9.242.0`| An exact image version. |
|`felddy/foundryvtt:9.242`| The most recent image matching the major and minor version numbers. |
...
distribution's name must be of the form: `foundryvtt-9.242.zip`
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `9.242` |
...
```console
docker build \
  --build-arg VERSION=9.242.0 \
  --tag felddy/foundryvtt:9.242.0 \
