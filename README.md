...
|`felddy/foundryvtt:9.226`| The most recent release matching the major and minor version numbers. |
...
distribution's name must be of the form: `foundryvtt-9.226.zip`
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `9.226` |
