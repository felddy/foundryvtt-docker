...
|`felddy/foundryvtt:0.7.6`| An exact version. |
...
distribution's name must be of the form: `foundryvtt-0.7.6.zip`
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `0.7.6` |
...
```console
docker build \
  --build-arg VERSION=0.7.6 \
  --tag felddy/foundryvtt:0.7.6 \
