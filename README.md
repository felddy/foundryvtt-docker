...
|`felddy/foundryvtt:10.279.0`| An exact image version. |
|`felddy/foundryvtt:10.279`| The most recent image matching the major and minor version numbers. |
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `10.279` |
...
```console
docker build \
  --build-arg VERSION=10.279.0 \
  --tag felddy/foundryvtt:10.279.0 \
