...
|`felddy/foundryvtt:0.6.5`| A specific version. |
...
be of the form: `foundryvtt-0.6.5.zip`
...
| FOUNDRY_VERSION | Version of Foundry Virtual Tabletop to install. | 0.6.5 |
...
```console
docker build \
  --build-arg VERSION=0.6.5 \
  --tag felddy/foundryvtt:0.6.5 \
