...
|`felddy/foundryvtt:0.7.7`| An exact version. |
...
distribution's name must be of the form: `foundryvtt-0.7.7.zip`
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `0.7.7` |
