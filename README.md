...
| `ghcr.io/felddy/foundryvtt:14.367` | The most recent image matching the major and minor version numbers. |
| `ghcr.io/felddy/foundryvtt:14.367.0` | An exact image version. |
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `14.367` |
...
```console
docker build \
  --build-arg CONTAINER_VERSION=14.367.0 \
  --build-arg FOUNDRY_VERSION=14.367 \
  --tag ghcr.io/felddy/foundryvtt:14.367.0 \
