...
| FOUNDRY_VERSION | Version of Foundry Virtual Tabletop to install. | 0.6.3 |
...
1. Build the image:
    ...
    ```console
    docker build \
      --build-arg VERSION=0.6.3 \
      --tag felddy/foundryvtt:0.6.3 .
    ```
