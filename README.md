...
|`felddy/foundryvtt:9.268.0`| An exact image version. |
|`felddy/foundryvtt:9.268`| The most recent image matching the major and minor version numbers. |
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `9.268` |
...
```console
docker build \
  --build-arg VERSION=9.268.0 \
  --tag felddy/foundryvtt:9.268.0 \
