...
|`felddy/foundryvtt:9.224.0`| An exact version. |
|`felddy/foundryvtt:9.224`| The most recent release matching the major and minor version numbers. |
...
distribution's name must be of the form: `foundryvtt-9.224.zip`
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `9.224` |
...
```console
docker build \
  --build-arg VERSION=9.224.0 \
  --tag felddy/foundryvtt:9.224.0 \
