...
|`felddy/foundryvtt:0.8.3`| An exact version. |
...
distribution's name must be of the form: `foundryvtt-0.8.3.zip`
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `0.8.3` |
