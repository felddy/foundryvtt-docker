...
|`felddy/foundryvtt:0.8.6`| An exact version. |
|`felddy/foundryvtt:0.8`| The most recent release matching the major and minor version numbers. |
...
distribution's name must be of the form: `foundryvtt-0.8.6.zip`
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `0.8.6` |
...
```console
docker build \
  --build-arg VERSION=0.8.6 \
  --tag felddy/foundryvtt:0.8.6 \
