...
|`felddy/foundryvtt:0.7.10`| An exact version. |
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `0.7.10` |
...
```console
docker build \
  --build-arg VERSION=0.7.10 \
  --tag felddy/foundryvtt:0.7.10 \
