...
|`felddy/foundryvtt:12.320.0`| An exact image version. |
|`felddy/foundryvtt:12.320`| The most recent image matching the major and minor version numbers. |
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `12.320` |
...
```console
docker build \
  --build-arg VERSION=12.320.0 \
  --tag felddy/foundryvtt:12.320.0 \
