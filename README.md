...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `9.255` |
...
```console
docker build \
  --build-arg VERSION=9.255.0 \
  --tag felddy/foundryvtt:9.255.0 \
