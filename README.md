...
|`felddy/foundryvtt:0.7.3`| A specific version. |
...
be of the form: `foundryvtt-0.7.3.zip`
...
| FOUNDRY_VERSION | Version of Foundry Virtual Tabletop to install. | 0.7.3 |
...
```console
docker build \
  --build-arg VERSION=0.7.3 \
  --tag felddy/foundryvtt:0.7.3 \
