...
|`felddy/foundryvtt:12.328.0`| An exact image version. |
|`felddy/foundryvtt:12.328`| The most recent image matching the major and minor version numbers. |
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `12.328` |
...
```console
docker build \
  --build-arg VERSION=12.328.0 \
  --tag felddy/foundryvtt:12.328.0 \
