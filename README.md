...
|`felddy/foundryvtt:0.7.4`| A specific version. |
...
be of the form: `foundryvtt-0.7.4.zip`
...
| FOUNDRY_VERSION | Version of Foundry Virtual Tabletop to install. | 0.7.4 |
...
```console
docker build \
  --build-arg VERSION=0.7.4 \
  --tag felddy/foundryvtt:0.7.4 \
