...
|`felddy/foundryvtt:0.8.8`| An exact version. |
...
distribution's name must be of the form: `foundryvtt-0.8.8.zip`
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `0.8.8` |
...
```console
docker build \
  --build-arg VERSION=0.8.8 \
  --tag felddy/foundryvtt:0.8.8 \
